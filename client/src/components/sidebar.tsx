              ...
              >
                ...
                <g mask="url(#mask0)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M2 0C0.895431 0 0 0.895431 0 2V8H8V0H2ZM12 0V8H28V2C28 0.895431 27.1046 0 26 0H12ZM28 12H12V28H26C27.1046 28 28 27.1046 28 26V12ZM8 28V12H0V26C0 27.1046 0.895431 28 2 28H8Z"
                    fill="#EF264D"
                  />
                  <path
                    d="M8.5 16.5C8.5 15.7 8.9 14.9 9.5 14.5V11.5H10.5V14.5C11.1 14.9 11.5 15.7 11.5 16.5C11.5 17.3 11.1 18.1 10.5 18.5V21.5H9.5V18.5C8.9 18.1 8.5 17.3 8.5 16.5Z"
                    fill="white"
                  />
                </g>
              </svg>
